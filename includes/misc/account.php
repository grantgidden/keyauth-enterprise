...
function addAccount($username, $role, $email, $password, $keyLevels, $owner, $name, $permissions)
{
        ...
        $query = mysql\query("INSERT INTO `accounts` (`username`, `email`, `password`, `role`, `app`, `owner`, `balance`, `keylevels`, `permissions`) VALUES (?, SHA1(?), ?, ?, ?, ?, '0|0|0|0|0|0|0', ?, b'$permissions')", [$username, $email, $pass_encrypted, $role, $name, $owner, $keyLevels]);
