...
try {
    ...
    if($_SESSION['discordLogin']) {
        throw new Exception('You can\'t use security keys when you sign-in with different website! Use security keys on that website instead, Discord supports security keys');
    }
